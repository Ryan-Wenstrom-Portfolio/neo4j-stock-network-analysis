...
def separate_nodes(
    ...
    """
    Prevent overlapping nodes while retaining
    spring-layout structure.
    """
...
def create_static_network(
    ...
    # Draw smaller nodes first so larger categories
...
def hover_text(
    ...
    return (
        ...
        "<b>Weighted PageRank:</b> "
        f"{weighted:.4f}<br>"

        "<b>Unweighted PageRank:</b> "
        f"{unweighted:.4f}<br>"

        "<b>Degree / neighbors:</b> "
        f"{degree}<br>"
